...
const Dashboard = () => {
  ...
  <div class="page-header">
   <div class="header-wrapper row m-0">
    ...
    <div class="header-logo-wrapper col-auto p-0">
     <div class="logo-wrapper"><a href="#"><img class="img-fluid" alt=""></a></div>
      ...
      <li class="profile-nav onhover-dropdown p-0 me-0">
       <div class="media profile-media">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 256 256">
         <path fill="black" d="M128 26a102 102 0 1 0 102 102A102.12 102.12 0 0 0 128 26ZM71.44 198a66 66 0 0 1 113.12 0a89.8 89.8 0 0 1-113.12 0ZM94 120a34 34 0 1 1 34 34a34 34 0 0 1-34-34Zm99.51 69.64a77.53 77.53 0 0 0-40-31.38a46 46 0 1 0-51 0a77.53 77.53 0 0 0-40 31.38a90 90 0 1 1 131 0Z" />
        </svg>

        <div class="media-body"><span>Alberto Beceira</span>
         <p class="mb-0 font-roboto">Admin <i class="middle fa fa-angle-down"></i></p>
        </div>
       </div>
       <ul class="profile-dropdown onhover-show-div">
        <li><a href="#"><i data-feather="user"></i><span>Perfil</span></a></li>
        <li><a href="#"><i data-feather="settings"></i><span>Cerra Sesion</span></a></li>
       </ul>
      </li>
     </ul>
    </div>
  ...
  <div class="page-body-wrapper">
   ...
   <div class="sidebar-wrapper">
    ...
    text-align: center;><a href="index.html"><img class="img-fluid for-light" style="
    height: 60px;" id="logo" alt=""><img id="logo" class="img-fluid for-dark" alt=""></a>
     ...
     <nav class="sidebar-main">
      ...
      <div id="sidebar-menu">
       <ul class="sidebar-links" id="simple-bar">
        ...
        <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i data-feather="file-text"></i><span>Pagina Principal</span></a>
        </li>

        <li class="sidebar-main-title">
         <div>
          <h6 class="lan-1">Pedidos</h6>
          <p class="lan-2"></p>
         </div>
        </li>
        <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i data-feather="file-text"></i><span>Listado de Pedido</span></a>
        </li>
        <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i data-feather="file-text"></i><span>Creacion de Pedido</span></a>
        </li>
        ...
        <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i data-feather="file-text"></i><span>Lista de Usuario</span></a>
        </li>

        <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i data-feather="file-text"></i><span>Creacion de Usuario</span></a>
        </li>

        <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i data-feather="file-text"></i><span>Activacion de Usuario</span></a>
        </li>

        <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i data-feather="file-text"></i><span>Roles y Membresia</span></a>
        </li>

        <li class="sidebar-main-title">
         <div>
          <h6 class="lan-1">Mantenedores</h6>
          <p class="lan-2"></p>
         </div>
        </li>
        <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i data-feather="file-text"></i><span>Mestro de Productos</span></a>
        </li>
        <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i data-feather="file-text"></i><span>Precios / Descuento </span></a>
        </li>
        <li class="sidebar-main-title">
         <div>
          <h6 class="lan-1">Reportes</h6>
          <p class="lan-2"></p>
         </div>
        </li>
        <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i data-feather="file-text"></i><span>Reportes de Ventas</span></a>
        </li>
        <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i data-feather="file-text"></i><span>Reportes de Afiliados</span></a>
        </li>
     </nav>
    </div>
   </div>
   ...
   <div class="page-body">
    ...
    <div class="container-fluid">
     ...
     <div class="row second-chart-list third-news-update">
       ...
       <div class="card o-hidden profile-greeting">
        <div class="card-body">
         ...
         <div class="greeting-user text-center">
          <div class="profile-vector"><img class="img-fluid" src="../assets/images/dashboard/account.svg" alt=""></div>
          <h4 class="f-w-600 m-2"><span id="greeting">Buenos dias</span> <span class="right-circle"><i class="fa fa-check-circle f-14 middle"></i></span></h4>
          <h4 class="m-0"><span>Alberto Beceira</span></h4>
      ...
      <div class="col-xl-8 col-lg-12 xl-50 calendar-sec box-col-6">
