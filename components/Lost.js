      ...
      <div class="row">
        <div class="col-12">
          <div class="login-card">
            <div>
              <div><a class="logo" href="#"><img class="img-fluid for-light" style="width: 20vw;" src="../assets/images/logo/logo.png" alt="looginpage"><img style="width: 20vw;" class="img-fluid for-dark" src="../assets/images/logo/logo.png" alt="looginpage"></a></div>
                ...
                <form class="theme-form">
                  ...
                  <div class="form-group mb-0 text-center">
                    <div class="checkbox p-0">
                      <button class="btn btn-primary btn-block text-center" type="submit">Cambiar </button>
                    </div>
                    <p class="mt-4 mb-0">¿Ya tienes una contraseña?<a class="ms-2" href="/">Iniciar Sesión</a></p>
                </form>
              </div>
            </div>
          </div>
